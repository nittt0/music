...
let songs = [
    {
        ...
        artist: "Halstage",
        album: "akbar",
        albumArtUrl: "https://files.catbox.moe/r5eavi.jpg",
        audioSrc: "https://files.catbox.moe/z4ho3j",
        videoBgSrc: "video/hall.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
            { time: 16 , text: "Sungguh tak terasa" },
            { time: 20, text: "Sudah tujuh tahun" },
            { time: 23, text: "Rotasi waktu hidupku" },
            { time: 30, text: "Binar mata yang membiru" },
            { time: 33, text: "Hari-hari yang lesuh" },
            { time: 36, text: "Aku menunggu kamu" },
            { time: 39, text: "Selalu aku lihat belakang punggungmu" },
            { time: 45, text: "Disaat kau lihat" },
            { time: 47, text: "Belakang punggung pria lain" },
            { time: 52, text: "Menunggu kau menoleh" },
            { time: 55, text: "Dan berlari ke arahku dan memelukku" },
            { time: 61, text: "Seerat-eratnya..." }
        ]
    },    
    {
        id: 6,
        ...
        artist: "Halstage", 
        album: "akbar",
        albumArtUrl: "https://files.catbox.moe/df3va0.jpg", 
        audioSrc: "https://files.catbox.moe/ip86z3.mp4",
        videoBgSrc: "video/terimakasih.mp4", // Path video background khusus lagu ini
        lyrics: [
            { time: 12, text: "terkadang sendu tak selalu merakit luka" },
            { time: 18, text: "ia juga mengisyaratkan bahagia" },
            { time: 23, text: "seperti saat itu kala ku lihat dia" },
            { time: 29, text: "menggandeng tanganmu dengan penuh mesra" },
            { time: 37, text: "kepadamu dulu aku jatuh cinta" },
            { time: 42, text: "menanam asa bisa bersama sepanjang usia" },
            { time: 48, text: "saat itu engkau di tepian kota" },
            { time: 54, text: "aku masih sendiri kau sudah jadi miliknya" },
            { time: 63, text: "terima kasih atas segala rasa" },
            { time: 68, text: "pada hari itu pun aku turut bahagia" },
            { time: 74, text: "karena aku selalu tahu" },
            { time: 80, text: "menyukaimu bukan berarti selaluuu" },
            { time: 88, text: "memilikimu..." }
        ]
    },
    {
        id: 6,
        ...
        artist: "Juicy Luicy",
        album: "JC",
        albumArtUrl: "https://files.catbox.moe/fglff7.jpg",
        audioSrc: "https://files.catbox.moe/oczjhx.mp4",
        videoBgSrc: "video/lantas.mp4", // Path video background khusus lagu ini
        lyrics: [
            { time: 10, text: "Lima hari sudah kurindu" },
            { time: 15.5, text: "Tak bisa ku menghubungimu" },
            { time: 20, text: "Kau sedang dengan dirinya" },
            { time: 23, text: "Sedang kita rahasia" },
            { time: 25.5, text: "Kapankah kau ada waktu" },
            { time: 28.5, text: "Sembunyi untuk bertemu" },
            
            { time: 32, text: "Baru kau sapa kutersipu" },
            { time: 37.5, text: "Kau puji lupa amarahku" },
            { time: 42.5, text: "Karena kau paling tahu" },
            { time: 45, text: "Cara lemahkan hatiku" },
            { time: 48, text: "Walau tak ada yang pasti" },
            { time: 50.5, text: "Yang kau beri hanya mimpi" },
